...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dtepmgg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dtepmgg.containers.anotherwebservice.com/
...
```
git clone git@github.com:GadzhetLak/container-dtepmgg.git
cd container-dtepmgg
```
...
```
docker attach container-dtepmgg
```
